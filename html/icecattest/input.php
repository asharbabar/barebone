            ...
            <div class="">
              <div class="grid simple">
                ...
                <div class="grid-body no-border">
                  ...
                  <p>Enter all your barcodes in a seperate line, make sure there are no spaces after or before your barcodes. After entering or pasting all your barcodes, click on the search button.</p>
                  <br>
                  <form action="result.php" method="POST" id="form_traditional_validation" name="form_traditional_validation" role="form" autocomplete="off" class="validate" novalidate="novalidate">
                    ...
                    <button class="btn btn-success btn-cons" type="submit"><i class="icon-ok"></i> IceCat Search</button>
                    </div>
                    </div>
                  </form>
                  </div>
